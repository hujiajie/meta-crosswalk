...
LICENSE_base/third_party/libevent = "BSD"
...
LICENSE_base/third_party/xdg_mime = "AFL-2.0 | LGPLv2"
LICENSE_base/third_party/xdg_user_dirs = "MIT"
LICENSE_breakpad = "BSD-3-Clause & APSL-2.0 & Apache-2.0"
LICENSE_buildtools/third_party/libc++ = "MIT & NCSA"
LICENSE_buildtools/third_party/libc++abi = "MIT & NCSA"
...
LICENSE_chromeos/third_party/android_bionic_libc = "BSD"
LICENSE_crypto/third_party/nss = "MPL-1.1 | GPL-2.0 | LGPL-2.1"
LICENSE_ios/third_party/blink = "BSD"
...
LICENSE_third_party/android_data_chart = "Apache-2.0"
LICENSE_third_party/android_media = "Apache-2.0"
LICENSE_third_party/android_opengl = "Apache-2.0"
LICENSE_third_party/android_swipe_refresh = "Apache-2.0"
...
LICENSE_third_party/brotli = "MIT"
LICENSE_third_party/cacheinvalidation = "Apache-2.0"
LICENSE_third_party/cardboard-java = "Apache-2.0"
...
LICENSE_third_party/crashpad = "Apache-2.0"
LICENSE_third_party/cros_system_api = "BSD"
LICENSE_third_party/custom_tabs_client = "Apache-2.0"
LICENSE_third_party/d3 = "BSD-3-Clause"
LICENSE_third_party/decklink = "BSL-1.0"
LICENSE_third_party/deqp = "Apache-2.0"
LICENSE_third_party/dom_distiller_js = "BSD"
LICENSE_third_party/errorprone = "Apache-2.0"
...
LICENSE_third_party/libc++-static = "MIT"
...
LICENSE_third_party/libsecret = "LGPL-2.1"
LICENSE_third_party/libsrtp = "BSD-3-Clause"
LICENSE_third_party/libudev = "LGPL-2.1"
LICENSE_third_party/libusb = "LGPL-2.1"
LICENSE_third_party/libva = "MIT"
LICENSE_third_party/libvpx_new = "BSD"
...
LICENSE_third_party/mesa = "MIT & LGPLv2"
LICENSE_third_party/minigbm = "BSD"
...
LICENSE_third_party/openh264 = "BSD-2-Clause"
...
LICENSE_third_party/proguard = "GPL-2.0"
...
LICENSE_third_party/speech-dispatcher = "GPLv2+"
...
LICENSE_third_party/v4l-utils = "LGPL-2.1"
LICENSE_third_party/wayland = "MIT"
LICENSE_third_party/wayland-protocols = "MIT"
LICENSE_third_party/wds = "LGPL-2.1"
LICENSE_third_party/web-animations-js = "Apache-2.0"
LICENSE_third_party/webrtc = "BSD"
LICENSE_third_party/woff2 = "Apache-2.0"
...
LICENSE_third_party/liblouis = "LGPL-3.0 & GPL-3.0"
...
LIC_FILES_CHKSUM = "\
    ...
    file://${S}/third_party/brotli/LICENSE;md5=0b99a0de24f591a89060ac1fba836c4d \
    ...
    file://${S}/third_party/ffmpeg/CREDITS.chromium;md5=7c10aa2e743c2ea20d02590d05ba75c7 \
    ...
    file://${S}/third_party/icu/LICENSE;md5=fddd726b6f3415beff5bcfb6eab25e52 \
    file://${S}/third_party/ijar/LICENSE;md5=b1e01b26bacfc2232046c90a330332b3 \
    file://${S}/third_party/isimpledom/LICENSE;md5=822502c0e010ccdbb6a3e681dd47888e \
    file://${S}/third_party/jmake/LICENSE;md5=b187600492949d6f6044ad0aff0d7584 \
    ...
    file://${S}/third_party/libc++-static/LICENSE.TXT;md5=149d2e8e8d99e3a2d702997b5f919fd9 \
    ...
    file://${S}/third_party/libpng/LICENSE;md5=b6865050df0842ef0892169e0721c8ca \
    ...
    file://${S}/third_party/libvpx_new/source/libvpx/LICENSE;md5=d5b04755015be901744a78cc30d390d4 \
    ...
    file://${S}/third_party/proguard/LICENSE;md5=5e44bb80a14435c4456416c0b370b7ea \
    ...
    file://${S}/third_party/skia/LICENSE;md5=36a47e6bd12ff3d433d813d0820ae872 \
...
do_install() {
    ...
    # 4) Inproper file ownership due to the use of 'cp -a' in installer.include.
    ...
    sed \
        ...
        ${S}/xwalk/tools/installer/common/wrapper \
        > ${D}/opt/crosswalk-project/crosswalk
    chmod 755 ${D}/opt/crosswalk-project/crosswalk
